...
if trace_type == "function":
    cmd = "python adonis.py -f paper_experiments/app/modbus/source/{}.wasm -s \
        -b paper_experiments/app/modbus/function_trace \
        --func_hooking adonis_res/{}_api2trace_function.json \
        -c adonis_res/{}_bb2line.json \
        -o {}_function".format(app, app, app, app)
else:
    cmd = "python adonis.py -f paper_experiments/app/modbus/source/{}.wasm -s \
        -b paper_experiments/app/modbus/syscall_trace \
        -c adonis_res/{}_bb2line.json \
        -o {}_syscall".format(app, app, app)
