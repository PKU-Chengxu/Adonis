...
def main():
    ...
    # function
    result_1 = evaluate(app, "function")
    # syscall
    result_2 = evaluate(app, "syscall")
...
def evaluate(app, type):
    assert type in ["function", "syscall"]
    os.system("mv ../../../../result/{}_{} ../../../../result/{}".format(app, type, app))
    ...
    of = "{}_{}_eva_result.json".format(app, type)
    ofp = open(of, "w")
    print("writing evaluation results to", of)
    json.dump(result, ofp, indent=2)

    os.system("mv ../../../../result/{} ../../../../result/{}_{}".format(app,app,type))
...
def evaluate_one(app, i, gd, ad):
    ...
    for j in range(full_path_num):
        ...
        try:
            ...
            mpp_file = result_dir + "/MPP_00.json"
    ...
    for j in range(MPP_num):
        try:
            # precision
            cov_file = result_dir + "/MPP_coverage_{:0>2d}.json".format(j)
